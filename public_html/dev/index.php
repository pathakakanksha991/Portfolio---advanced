          ...
          <div class="service-contents">
            ...
            <div class="col-md-6 col-md-offset-2">
              <div class="service-item">
                <img src="media/designer/Proj (1).png">
        ...
        <div id="portfolio">
          ...
          or ($x = 0; $x <= 24; $x++) {
            echo <div class="tile scale-anm ec all">
              <img src="$dir2.$Extra-curricular[$x]" alt="" data-toggle="modal" data-target=".ec-$x" />
            </div>
...
<!--
        ...
        or ($x = 0; $x <= 24; $x++) {
          ...
          <div class="modal fade ec-$x" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <img src="$dir1.$Extra-curricular[$x]" alt="" class="img-responsive" />
              </div>
            </div>
          </div>
        ...
        or ($x = 0; $x <= 7; $x++) {
          ...
          <div class="modal fade tech-$x" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <img src="$dir1.$Technology[$x]" alt="" class="img-responsive" />
              </div>
            </div>
          </div>
